...
public class LocalizationGroup {
    ...
    public LocalizedText getTranslation(DaseinPersist persistence, Locale ... localePreferences) throws PersistenceException {
        if( localePreferences == null ) {
            localePreferences = new Locale[0];
        }
        Collection<LocalizedText> translations = LocalizedText.getTranslations(persistence, textGroup, textId);
